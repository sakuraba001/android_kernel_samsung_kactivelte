...
ifeq ($(CONFIG_SEC_K_PROJECT),y)
    ifeq ($(CONFIG_MACH_KLTE_KOR),y)
	 ...
	 ifeq ($(CONFIG_MACH_KACTIVELTE_DCM),y)
		# dtbs for KACTIVE DCM
		dtb-$(CONFIG_SEC_K_PROJECT)	+= msm8974pro-ac-sec-kactiveltedcm-r13.dtb
		dtb-$(CONFIG_SEC_K_PROJECT)	+= msm8974pro-ac-sec-kactiveltedcm-r14.dtb
    	else
		# dtbs for KLTE JPN
