...
make -C $(pwd) O=output CROSS_COMPILE=arm-linux-androideabi- msm8974_sec_defconfig VARIANT_DEFCONFIG=msm8974pro_sec_kactivelte_dcm_defconfig SELINUX_DEFCONFIG=selinux_defconfig
